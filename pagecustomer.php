    ...
    <section class="main">
        ...
        <div class="recent--patients">
                <div class="title">
                   ...
                   <!-- <button class="add"><a href="Ajouterboutique.php"><i class="ri-add-line"></i>Add Customer</a></button>
--></div>
        ...
        ?>
            <tr>
               <td><?php echo $ligne['idClient']; ?></td>
                ...
                <td><span><a href="supcustomer.php?supidc=<?php echo $ligne['idClient']; ?>"><i class="ri-delete-bin-line delete"></i></a></span></td>
            </tr>
