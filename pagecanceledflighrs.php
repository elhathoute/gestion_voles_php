...
<section class="header">
    ...
    <section class="main">
        ...
        <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title">Canceled Flights</h2>
	...
	$reqselect="select * from vol_annule";
	...
	?>
                            <tr>
                                <td><?php echo $ligne['id_vol_annule']; ?></td>
                                <td><?php echo $ligne['idVol']; ?></td>
                                <td><?php echo $ligne['raison_annulation']; ?></td>
                             
                              
                                <td><span><a href="modifierboutique.php?mod=<?php echo $ligne['id_vol_annule']; ?>"><i class="ri-edit-line edit"></i></a><a href="supprimerfleurs.php?supid=<?php echo $ligne['id_vol_annule']; ?>"><i class="ri-delete-bin-line delete"></i></a></span></td>
