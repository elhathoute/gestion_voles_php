...
if (isset($_POST['btaddflight'])) {
    ...
    $sql = "INSERT INTO vol (idVol, numeroVol, heureDepart, heureArrivee, idAeroportDepart, idAeroportArrivee, idCompagnie, idStatut) VALUES ('$idVol', '$numeroVol', '$heureDepart', '$heureArrivee', '$idAeroportDepart', '$idAeroportArrivee', '$idCompagnie', '$idStatut')";
    ...
    if (mysqli_query($conn, $sql)) {
      ...
      // echo "Erreur lors de l'ajout du vol: " . mysqli_error($conn);
      header('location: pageadmin.html.php');
    }
...
--></div>
                <div class="container">
            <br>
    <h1 class="h1">Add Flight:</h1><br><br>
    ...
    <input type="submit" name="btaddflight" value="ADD Flight" class="button">
</form>
