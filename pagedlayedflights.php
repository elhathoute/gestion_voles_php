...
<section class="header">
    ...
    <section class="main">
        ...
        <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title">Delayed Flights</h2>
	...
	$reqselect="select * from vol_retarde";
	...
	?>
                            <tr>
                                <td><?php echo $ligne['id_vol_retarde']; ?></td>
                                <td><?php echo $ligne['idVol']; ?></td>
                                <td><?php echo $ligne['duree_retard']; ?></td>
                             
                              
                                <td><span><a href="modifierboutique.php?mod=<?php echo $ligne['id_vol_retarde']; ?>"><i class="ri-edit-line edit"></i></a><a href="supprimerfleurs.php?supid=<?php echo $ligne['id_vol_retarde']; ?>"><i class="ri-delete-bin-line delete"></i></a></span></td>
