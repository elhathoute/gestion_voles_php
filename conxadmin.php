    ...
    <section class="main">
        ...
        <div class="recent--patients">
            ...
            <form action="" method="post" class="formulaire">
                <br><br><br>
                <h1 class="h1">Connexion d'Administrateur:</h1>
                <br><br>
 <label><b>Identificateur d'Administrateur</b></label>
 <input type="text" placeholder="Entrer vote email " name="login" required>
<br>
...
<br>
                ...
                if (isset($_POST['btlogin'])) {
                    $req = "SELECT * FROM administrateur WHERE email = '" . $_POST['login'] . "' AND motDePasse = '" . $_POST['password'] . "'";
