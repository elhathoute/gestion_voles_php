...
<div class="container">
<br><br>
<h1 class="h1">Flight search by:</h1><br><br>

<center><button type="submit" name="searchByNumero" formaction="saerchnumero.php" class="button"><a href="saerchnumero.php">
    search By Numero</a></button><br><br></center>
<center><button type="submit" name="searchByProvenanceDestination" formaction="searchprovenance.php" class="button"><a href="searchprovenance.php"></a>
    search By Provenance or Destination</button><br><br></center>
<center><button type="submit" name="searchByCompagnieAeroport" formaction="searchaero.php" class="button"><a href="searchaero.php">
    Search By Compagnie and Aeroport</a></button><br><br></center>
