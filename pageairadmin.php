...
<section class="header">
	...
	$reqselect="select * from administrateuraeroport";
	...
	?>
                            <tr>
                                <td><?php echo $ligne['idAdminAeroport']; ?></td>
                                <td><?php echo $ligne['nom']; ?></td>
                                <td><?php echo $ligne['prenom']; ?></td>
                                <td><?php echo $ligne['email']; ?></td>
                                <td><?php echo $ligne['motDePasse']; ?></td>
                             <td><?php echo $ligne['idAeroport']; ?></td>
                             <td><?php echo $ligne['PHOTO']; ?></td>
                             <td><?php echo $ligne['last_login']; ?></td>
                                <td><span><a href="modifierboutique.php?mod=<?php echo $ligne['idAdminAeroport']; ?>"><i class="ri-edit-line edit"></i></a><a href="supprimerfleurs.php?supid=<?php echo $ligne['idAdminAeroport']; ?>"><i class="ri-delete-bin-line delete"></i></a></span></td>
